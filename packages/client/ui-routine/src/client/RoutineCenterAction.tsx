...
export interface RoutineProjection { readonly routines: readonly RoutineView[]; readonly runs: readonly { readonly routineId: string; readonly status: string; readonly finishedAt?: string; readonly sessionId?: string }[] }
