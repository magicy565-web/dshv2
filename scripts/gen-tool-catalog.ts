...
import * as ToolRoutine from '@deepseek-ai/dsh-tool-routine'
...
const TOOL_PACKAGES: ToolPackage[] = [
  ...
  {
    pkg: '@deepseek-ai/dsh-tool-routine',
    dir: 'tool-routine',
    source: 'packages/routine/tool-routine/src/index.ts',
    requires: ['ctx.tools', 'ctx.routine', 'an owning Agent for routine management calls'],
    ...
    note:
      'Routine tools create durable one-time or fixed-interval plans whose due work starts an independent Agent Session. The provider stores definitions and runs in the dedicated routine storage domain; routine_run_now does not move the saved schedule.',
  },
  {
