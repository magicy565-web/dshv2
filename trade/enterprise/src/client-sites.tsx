...
.site-build-log{white-space:pre-wrap;overflow-wrap:anywhere;max-height:320px;overflow:auto;padding:12px;border-radius:8px;background:var(--dsw-alias-bg-layer-2);font:12px/1.6 ui-monospace,monospace}.site-assets{margin-top:20px;border:1px solid var(--dsw-alias-border-l4);border-radius:10px;padding:16px}.site-assets input[type=file]{max-width:100%}.site-assets label{display:flex;align-items:center;gap:6px}.site-domains{margin-top:24px}.site-dns{margin-top:16px;overflow:auto}.site-dns table{width:100%;border-collapse:collapse;margin-top:12px;text-align:left}.site-dns th,.site-dns td{padding:8px;border-bottom:1px solid var(--dsw-alias-border-l4);vertical-align:top}.site-dns code{overflow-wrap:anywhere}.site-domains input{min-width:0;max-width:100%}
